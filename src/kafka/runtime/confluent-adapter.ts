...
import { KTCompressionTypes } from "../kafka-types.js";
...
class KTConfluentKafkaConsumerAdapter implements KTRuntimeConsumer {
...
class KTConfluentKafkaProducerAdapter implements KTRuntimeProducer {
  #producer: ConfluentProducerLike;
  #connected = false;
  ...
  createDependentAdmin(): KTRuntimeAdmin {
    return new KTConfluentKafkaAdminAdapter(
...
class KTConfluentKafkaAdminAdapter implements KTRuntimeAdmin {
...
class KTConfluentKafkaClientAdapter implements KTRuntimeClient {
  ...
  createProducer(params: { createPartitioner?: unknown, compression?: unknown }): KTRuntimeProducer {
    ...
    return new KTConfluentKafkaProducerAdapter(this.#kafka.producer(producerConfig) as unknown as ConfluentProducerLike);
  }
  ...
  createConsumer(params: {
    ...
    return new KTConfluentKafkaConsumerAdapter(this.#kafka.consumer(consumerConfig) as ConfluentConsumerLike);
  }
}

export { KTConfluentKafkaClientAdapter };
